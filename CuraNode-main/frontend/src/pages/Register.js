...
const Register = () => {
  ...
  const departments = {
    'doctor': ['Cardiology', 'Pediatrics', 'Orthopedics', 'Neurology', 'General Medicine'],
    'nurse': ['ICU', 'General Ward', 'Emergency', 'Operating Theatre', 'Maternity'],
    'diagnostic-staff': ['Lab', 'Pathology', 'Radiology', 'Imaging', 'Ultrasound'],
    'pharmacy': ['Main Pharmacy', 'Hospital Pharmacy', 'Outpatient Pharmacy'],
  };
