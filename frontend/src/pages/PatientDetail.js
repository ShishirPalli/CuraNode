  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        {/* Action-Centric Patient Timeline */}
        {actionsList.length > 0 ? (
          <div style={{
            position: 'relative',
            paddingLeft: '0px',
          }}>
            {/* Timeline vertical line - improved */}
            <div style={{
              position: 'absolute',
              left: '20px',
              top: '0',
              bottom: '0',
              width: '2px',
              backgroundColor: 'linear-gradient(180deg, var(--primary-blue) 0%, var(--primary-green) 100%)',
            }}></div>

            {actionsList.map((action, index) => {
              const createdDate = new Date(action.createdAt);
              const completedDate = action.completedAt ? new Date(action.completedAt) : null;
                ...
                <div key={action._id} style={{
                  ...
                  <div style={{
                    ...
                    backgroundColor: action.status === 'completed' ? '#10b981' :
                      ...
                      action.status === 'pending' ? '#f59e0b' : '#6b7280',
                  ...
                  <div style={{
                      ...
                      <div style={{
                        ...
                        <span style={{
                          ...
                          backgroundColor: action.status === 'completed' ? '#d1fae5' :
                            ...
                            action.status === 'pending' ? '#fef3c7' : '#f3f4f6',
                          color: action.status === 'completed' ? '#047857' :
                            action.status === 'in-progress' ? '#0369a1' :
                            action.status === 'pending' ? '#b45309' : '#6b7280',
                          fontWeight: '600',
                          border: `1px solid ${action.status === 'completed' ? '#a7f3d0' :
                            action.status === 'in-progress' ? '#a5f3fc' :
                            action.status === 'pending' ? '#fcd34d' : '#e5e7eb'}`,
                        }}>
                        ...
                        <span style={{
                          ...
                          backgroundColor: action.priority === 'urgent' ? '#fee2e2' :
                            ...
                            action.priority === 'medium' ? '#cffafe' : '#f3f4f6',
                          color: action.priority === 'urgent' ? '#991b1b' :
                            action.priority === 'high' ? '#b45309' :
                            action.priority === 'medium' ? '#0369a1' : '#6b7280',
                          fontWeight: '600',
                          border: `1px solid ${action.priority === 'urgent' ? '#fca5a5' :
                            action.priority === 'high' ? '#fcd34d' :
                            action.priority === 'medium' ? '#a5f3fc' : '#e5e7eb'}`,
                        }}>
                    ...
                    <div style={{
                      ...
                      <div>
                        <span style={{ color: 'var(--gray-500)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '600' }}>Department</span>
                        <p style={{ margin: '4px 0 0 0', fontWeight: '600', color: 'var(--gray-700)' }}>
                          🏥 {action.departmentAssigned}
                        </p>
                      </div>
                      <div>
                        <span style={{ color: 'var(--gray-500)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '600' }}>Initiated By</span>
                        <p style={{ margin: '4px 0 0 0', fontWeight: '600', color: 'var(--gray-700)' }}>
                          👤 {action.initiatedBy?.firstName || 'Unknown'}
                        </p>
                      </div>
                      <div>
                        <span style={{ color: 'var(--gray-500)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '600' }}>Created</span>
                        <p style={{ margin: '4px 0 0 0', fontWeight: '600', color: 'var(--gray-700)' }}>
                      ...
                      {action.completedAt && (
                        <div>
                          <span style={{ color: 'var(--gray-500)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '600' }}>Completed By</span>
                          <p style={{ margin: '4px 0 0 0', fontWeight: '600', color: 'var(--gray-700)' }}>
                            👤 {action.completedBy?.firstName || 'Unknown'}
                          </p>
                        </div>
                      )}
                      {action.completedAt && (
                        <div>
                          <span style={{ color: 'var(--gray-500)', fontSize: '10px', textTransform: 'uppercase', fontWeight: '600' }}>Completed</span>
                          <p style={{ margin: '4px 0 0 0', fontWeight: '600', color: 'var(--primary-green)' }}>
                    ...
                    {action.completionNotes && (
                      <div style={{
                        ...
                        <p style={{
                          ...
                          <strong>Completion Notes:</strong> {action.completionNotes}
                        </p>
                      </div>
                    )}
          ...
          <div style={{
            ...
            <p style={{ margin: '0', fontSize: '15px', fontWeight: '600', color: 'var(--gray-500)' }}>No clinical actions yet</p>
            <p style={{ fontSize: '13px', color: 'var(--gray-400)', marginTop: '8px' }}>
              Create a new action to start tracking this patient's care workflow
            </p>
          </div>
        )}
      </div>
